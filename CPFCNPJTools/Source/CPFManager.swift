...
/// The `CPFManager` class is responsible for validating, generating, and formatting CPF numbers (Brazilian Individual Taxpayer Registry).
///
...
public class CPFManager {
    ...
    /// **Usage example:**
    /// ```swift
    /// let result = CPFManager.validate(cpf: "11144477735")
    /// print(result) // .valid or .invalid
    /// ```
    public static func validate(cpf: String) -> CPFStatus {
    ...
    /// **Usage example:**
    /// ```swift
    /// let fakeCPF = CPFManager.generate()
    ...
    public func generateMasked() -> String? {
        return format(CPFManager.generate())
    }
    ...
    /// **Usage example:**
    /// ```swift
    /// let formatted = CPFManager.format("11144477735")
    ...
    /// **Usage example:**
    /// ```swift
    /// let checkSum = CPFManager.calculateCPFCheckSum(cpfBaseDigits: [1, 1, 1, 4, 4, 4, 7, 7, 7], multiplyBy: 10)
    /// print(checkSum) // Result of the calculation
    /// ```
    private static func calculateCPFCheckSum(cpfBaseDigits: [Int], multiplyBy: Int) -> Int {
    ...
    /// ```
    public static func mask(cpf: String) -> String {
